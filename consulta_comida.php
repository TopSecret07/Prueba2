...
if ($result->num_rows > 0) {
    ...
    // Verificar si el enlace existe en la tabla "comidas"
    $sqlComida = "SELECT * FROM comidas WHERE enlace_qr = '$qr_content'";
    $resultComida = $conn->query($sqlComida);

    if ($resultComida->num_rows == 0) {
        // El enlace no existe en la tabla "comidas," agrega un nuevo registro
        $insertSql = "INSERT INTO comidas (enlace_qr) VALUES ('$qr_content')";
